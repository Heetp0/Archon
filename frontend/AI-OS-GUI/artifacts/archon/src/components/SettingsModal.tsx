...
function ProjectDetailView({ project, onBack }: { project: Project; onBack: () => void }) {
  const { removeContextFile, updateAgentSettings } = useProjectsContext();
...
export default function SettingsModal() {
  ...
  return (
    <Dialog open={settingsOpen} onOpenChange={setSettingsOpen}>
      <DialogContent className="max-w-[820px] w-full p-0 bg-[#08090f] border border-white/[0.08] text-slate-200 overflow-hidden rounded-2xl">
        <div className="flex h-[620px]">
          ...
          <div className="w-44 flex-shrink-0 bg-[#08090f] border-r border-white/[0.05] flex flex-col py-4">
            ...
            <div className="px-3 mt-4">
              <Button className="w-full bg-blue-600/80 hover:bg-blue-500 text-white text-xs font-mono rounded-xl" size="sm" data-testid="button-settings-save">
              ...
              {tab === "parameters" && (
                <div className="space-y-6">
                  <div className="space-y-3">
                    ...
                    <Slider value={[temp]} onValueChange={([v]) => setTemp(v)} max={100} step={1} className="[&_[role=slider]]:bg-slate-300 [&_[role=slider]]:rounded-lg" />
                  ...
                  <div className="space-y-3">
                    ...
                    <Slider value={[maxTok]} onValueChange={([v]) => setMaxTok(v)} min={512} max={32768} step={512} className="[&_[role=slider]]:bg-slate-300 [&_[role=slider]]:rounded-lg" />
